  ...
  <div>
    ...
    <nav class="header-navbar">
      ...
      <span class="left-menu-icons">
        ...
        <label class="account-type  hide-on-mobile" v-bind:class="{'bg-warning': user.plan === 'enterprise', 'bg-danger': user.plan === 'Trial' || user.plan === 'Expired', 'bg-gray': user.plan === 'premium', 'bg-white': user.plan === 'basic'}" v-if="user !== null && user.plan !== null">{{user.plan.toUpperCase()}}</label>
      </span>
